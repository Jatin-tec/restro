  ...
  return (
    <div className="container mx-auto p-4">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold">Restaurant QR Generator</h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="w-full max-w-sm mx-auto">
          ...
          <CardContent className="flex flex-col items-center justify-center h-96"> {/* Adjust height for centering */}
            ...
            <Button className="w-full mt-4" onClick={() => alert("Download JPG functionality coming soon!")}>Download JPG</Button>
          </CardContent>
        </Card>
        ...
        <Card className="w-full max-w-lg mx-auto">
          ...
          <CardContent>
            <div className="mt-4">
              <label className="block font-medium mb-2">Select QR Color 1</label>
              <Input type="color" value={color1} onChange={handleColor1Change} className="w-full" />
            </div>
            <div className="mt-4">
              <label className="block font-medium mb-2">Select QR Color 2</label>
              <Input type="color" value={color2} onChange={handleColor2Change} className="w-full" />
            </div>
          </CardContent>
        </Card>
      </div>
